<h2><a href="https://www.geeksforgeeks.org/problems/form-a-palindrome1455/1?page=1&category=Dynamic%20Programming&company=Amazon,Google&status=unsolved&sortBy=submissions">Form a palindrome</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a string, find the minimum number of characters to be inserted to convert it to a palindrome.<br></span></p>
