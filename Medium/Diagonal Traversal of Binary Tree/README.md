<h2><a href="https://www.geeksforgeeks.org/problems/diagonal-traversal-of-binary-tree/1?page=3&category=Tree,Linked%20List&company=Microsoft&sortBy=submissions">Diagonal Traversal of Binary Tree</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a Binary Tree, print the <strong>diagonal traversal</strong> of the binary tree.</span></p>
...
<a href="http://d1hyf4ir1gqw6c.cloudfront.net//wp-content/uploads/unnamed1.png" previewlistener="true"><img alt="unnamed" class="alignnone size-full wp-image-137695" src="https://contribute.geeksforgeeks.org/wp-content/uploads/diagonal.jpg" style="height:264px; width:406px">
